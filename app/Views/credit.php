        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="data_table" cellspacing="0">
                    <thead>
                        <tr>
                                     <th>Id</th>         <th>User id</th>         <th>Category id</th>         <th>Nominal</th>         <th>Keterangan</th>         <th>Tanggal</th>         <th>Created at</th>         <th>Updated at</th>
                            <th></th>
                        </tr>
                    </thead>
                </table>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="number" id="userId" name="userId" class="form-control" placeholder="User id"  maxlength="11" number="true" required>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
	                <label for="categoryId"> Category id: <span class="text-danger">*</span> </label>
                  <input type="number" id="categoryId" name="categoryId" class="form-control" placeholder="Category id"  maxlength="11" number="true" required>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <textarea cols="40" rows="5" id="" name="description" class="form-control" placeholder="Keterangan"  ></textarea>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
	                <label for="creditDate"> Tanggal: <span class="text-danger">*</span> </label>
                  <input type="date" id="creditDate" name="creditDate" class="form-control" dateISO="true" required>
                </div>
              </div>
            </div>
...
<script>
  ...
  function edit(id) {
    $.ajax({
      ...
      $("#edit-form #creditDate").val(response.credit_date);
